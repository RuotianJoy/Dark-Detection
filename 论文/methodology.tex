...
\bibitem{1} Redmon, J., Divvala, S., Girshick, R., \& Farhadi, A. (2016). You only look once: Unified, real-time object detection. In \textit{Proceedings of the IEEE conference on computer vision and pattern recognition} (pp. 779-788). \url{https://doi.org/10.1109/CVPR.2016.91}

\bibitem{2} Jiang, H., Learned-Miller, E. (2017). Face detection with the faster R-CNN. In \textit{2017 12th IEEE international conference on automatic face \& gesture recognition} (pp. 650-657). IEEE. \url{https://doi.org/10.1109/FG.2017.82}

\bibitem{3} Liu, W., Anguelov, D., Erhan, D., Szegedy, C., Reed, S., Fu, C. Y., \& Berg, A. C. (2016). SSD: Single shot multibox detector. In \textit{European conference on computer vision} (pp. 21-37). Springer. \url{https://doi.org/10.1007/978-3-319-46448-0_2}

\bibitem{4} Koirala, A., Walsh, K. B., Wang, Z., \& McCarthy, C. (2019). Deep learning for real-time fruit detection and orchard fruit load estimation: benchmarking of 'MangoYOLO'. \textit{Precision Agriculture}, 20(6), 1107-1135. \url{https://doi.org/10.1007/s11119-019-09642-0}

\bibitem{5} Bochkovskiy, A., Wang, C. Y., \& Liao, H. Y. M. (2020). YOLOv4: Optimal speed and accuracy of object detection. \textit{arXiv preprint arXiv:2004.10934}. \url{https://arxiv.org/abs/2004.10934}

\bibitem{6} Esteva, A., Kuprel, B., Novoa, R. A., Ko, J., Swetter, S. M., Blau, H. M., \& Thrun, S. (2017). Dermatologist-level classification of skin cancer with deep neural networks. \textit{Nature}, 542(7639), 115-118. \url{https://doi.org/10.1038/nature21056}

\bibitem{7} Tabernik, D., Šela, S., Skvarč, J., \& Skočaj, D. (2020). Segmentation-based deep-learning approach for surface-defect detection. \textit{Journal of Intelligent Manufacturing}, 31(3), 759-776. \url{https://doi.org/10.1007/s10845-019-01476-x}

\bibitem{8} Takeda, M., Ina, H., \& Kobayashi, S. (1982). Fourier-transform method of fringe-pattern analysis for computer-based topography and interferometry. \textit{Journal of the Optical Society of America}, 72(1), 156-160. \url{https://doi.org/10.1364/JOSA.72.000156}

\bibitem{9} Bone, D. J., Bachor, H. A., \& Sandeman, R. J. (1986). Fringe-pattern analysis using a 2-D Fourier transform. \textit{Applied optics}, 25(10), 1653-1660. \url{https://doi.org/10.1364/AO.25.001653}

\bibitem{10} Wang, C. Y., Bochkovskiy, A., \& Liao, H. Y. M. (2023). YOLOv7: Trainable bag-of-freebies sets new state-of-the-art for real-time object detectors. In \textit{Proceedings of the IEEE/CVF Conference on Computer Vision and Pattern Recognition} (pp. 7464-7475). \url{https://doi.org/10.1109/CVPR52729.2023.00721}

\bibitem{11} Ghiglia, D. C., \& Pritt, M. D. (1998). \textit{Two-dimensional phase unwrapping: theory, algorithms, and software}. Wiley. \url{https://doi.org/10.1002/9780470191668}

\bibitem{12} Yan, K., Yu, Y., Huang, C., Sui, L., Qian, K., \& Asundi, A. (2020). Fringe pattern denoising based on deep learning. \textit{Optics Communications}, 437, 148-152. \url{https://doi.org/10.1016/j.optcom.2018.12.058}

\bibitem{13} Feng, S., Chen, Q., Gu, G., Tao, T., Zhang, L., Hu, Y., ... \& Zuo, C. (2021). Fringe pattern analysis using deep learning. \textit{Advanced Photonics}, 1(2), 025001. \url{https://doi.org/10.1117/1.AP.1.2.025001}

\bibitem{14} Zhang, S. (2018). High-speed 3D shape measurement with structured light methods: A review. \textit{Optics and Lasers in Engineering}, 106, 119-131. \url{https://doi.org/10.1016/j.optlaseng.2018.02.017}

\bibitem{15} Luo, H., Yang, Y., Tong, B., Wu, F., \& Fan, B. (2018). Traffic sign recognition using a multi-task convolutional neural network. \textit{IEEE Transactions on Intelligent Transportation Systems}, 19(4), 1100-1111. \url{https://doi.org/10.1109/TITS.2017.2726038}

\bibitem{16} Park, C., Huang, J. Z., Ji, J. X., \& Ding, Y. (2013). Segmentation, inference and classification of partially overlapping nanoparticles. \textit{IEEE transactions on pattern analysis and machine intelligence}, 35(3), 669-681. \url{https://doi.org/10.1109/TPAMI.2012.163}

\bibitem{17} Dainty, J. C. (Ed.). (2013). \textit{Laser speckle and related phenomena} (Vol. 9). Springer Science \& Business Media. \url{https://doi.org/10.1007/978-3-642-57323-1}

\bibitem{18} Malacara, D. (Ed.). (2007). \textit{Optical shop testing} (Vol. 59). John Wiley \& Sons. \url{https://doi.org/10.1002/9780470135976}

\bibitem{19} Hariharan, P. (2003). \textit{Optical interferometry}. Academic press. \url{https://doi.org/10.1016/B978-012311630-7/50000-3}

\bibitem{20} Wang, K., Kemao, Q., Di, J., \& Zhao, J. (2021). Deep learning spatial phase unwrapping: a comparative review. \textit{Advanced Photonics Nexus}, 1(1), 014001. \url{https://doi.org/10.1117/1.APN.1.1.014001}

\bibitem{21} Spoorthi, G. E., Gorthi, S., \& Gorthi, R. K. S. S. (2019). PhaseNet: a deep convolutional neural network for two-dimensional phase unwrapping. \textit{IEEE Signal Processing Letters}, 26(1), 54-58. \url{https://doi.org/10.1109/LSP.2018.2879184}
